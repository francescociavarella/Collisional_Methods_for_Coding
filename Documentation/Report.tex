...
\begin{document}
	...
	Once all physical parameters, initial states, and dynamics functions have been defined, the simulations could be run for different $ \Delta t $ and $ N_{Traj} $ values, in order to test \textit{Convergence Properties}. This is achieved through nested loops iterating over the defined parameter lists.	All resulting data are stored and organized in the \textit{Dictionary} \texttt{results}, which has the following structure:

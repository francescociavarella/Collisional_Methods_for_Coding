...
\begin{document}
	...
	While the stochastic unraveling focuses on individual trajectories of the wf, the \textit{Collisional Mode}l can also be formulated deterministically for the complete Density Matrix $ \rho_S \otimes \rho_A $. \\
